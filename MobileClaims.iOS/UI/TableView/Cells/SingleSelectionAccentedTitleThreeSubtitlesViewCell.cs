...
{
	public class SingleSelectionAccentedTitleThreeSubtitlesViewCell : MvxDeleteTableViewCell
	{
		public UILabel title,label,label2,label3;
		protected UIView cellBackingView;

		public SingleSelectionAccentedTitleThreeSubtitlesViewCell() : base () {}
		public SingleSelectionAccentedTitleThreeSubtitlesViewCell(IntPtr handle) : base (handle) {}
		...
		public override void CreateLayout()
		{
			...
			if (title == null)
				title = new UILabel ();
			title.Frame = new CGRect (Constants.SINGLE_SELECTION_ACCENTED_TITLE_TITLE_PADDING_LEFT, Constants.SINGLE_SELECTION_ACCENTED_TITLE_CELL_HEIGHT/2-Constants.SINGLE_SELECTION_ACCENTED_TITLE_CELL_CONTENTS_HEIGHT/2, Frame.Width-Constants.SINGLE_SELECTION_ACCENTED_TITLE_TITLE_PADDING_LEFT, (float)title.Frame.Height);
			title.SizeToFit ();
			title.Font = UIFont.FromName(Constants.NUNITO_BOLD,(nfloat)Constants.SINGLE_SELECTION_LABEL_FONT_SIZE);
			...
			if (label == null)
				label = new UILabel ();
			label.Frame = new CGRect (Constants.SINGLE_SELECTION_ACCENTED_TITLE_SUBTITLE_PADDING_LEFT, (float)title.Frame.Y+(float)title.Frame.Height+Constants.SINGLE_SELECTION_ACCENTED_TITLE_INNER_MARGIN, Frame.Width-Constants.SINGLE_SELECTION_ACCENTED_TITLE_SUBTITLE_PADDING_LEFT, (float)label.Frame.Height);
			label.SizeToFit ();
			...
			if (label2 == null)
				label2 = new UILabel ();
			label2.Frame = new CGRect (Constants.SINGLE_SELECTION_ACCENTED_TITLE_SUBTITLE_PADDING_LEFT, (float)label.Frame.Y+(float)label.Frame.Height+Constants.SINGLE_SELECTION_ACCENTED_TITLE_INNER_MARGIN, Frame.Width-Constants.SINGLE_SELECTION_ACCENTED_TITLE_SUBTITLE_PADDING_LEFT, (float)label2.Frame.Height);
			label2.SizeToFit ();
			...
			if (label3 == null)
				label3 = new UILabel ();
			label3.Frame = new CGRect (Constants.SINGLE_SELECTION_ACCENTED_TITLE_SUBTITLE_PADDING_LEFT, (float)label2.Frame.Y+(float)label2.Frame.Height+Constants.SINGLE_SELECTION_ACCENTED_TITLE_INNER_MARGIN, Frame.Width-Constants.SINGLE_SELECTION_ACCENTED_TITLE_SUBTITLE_PADDING_LEFT, (float)label3.Frame.Height);
			label3.SizeToFit ();
		...
		private void SetHighlightColors(bool selected)
		{
			...
			title.TextColor = label.TextColor;
		}
