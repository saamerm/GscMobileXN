...
namespace MobileClaims.Droid.Views.Fragments
{
    ...
    public class SupportCenterFragment_ : BaseFragment
    {
        private WebView _webView;
        private SupportCenterViewModel _model;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return this.BindingInflate(Resource.Layout.SupportCenterFragment, null);
        }

        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            base.OnViewCreated(view, savedInstanceState);
            var webViewClient = new SupportCenterWebViewClient {_sH = this};
            _model = (SupportCenterViewModel) ViewModel;
            try
            {
                ...
                var set = this.CreateBindingSet<SupportCenterFragment_, SupportCenterViewModel>();
    ...
    public class SupportCenterWebViewClient : WebViewClient
    {
        public SupportCenterFragment_ _sH;
