...
namespace MobileClaims.Droid.Views
{
    ...
    //	, NoHistory = true
    public class AuditListView : ActivityBase, IMultiRegionHost
    {
        ...
        public override void OnBackPressed()
        {
            ...
            {
                ((AuditListViewModel)this.ViewModel).GoBackCommand.Execute(null);
            }
            base.OnBackPressed();
        }
        ...
        protected override void OnViewModelSet()
        {
            ...
            var cvf = new AuditListViewFragment_
            {
                ViewModel = ViewModel
            };
            Show(cvf, true);
