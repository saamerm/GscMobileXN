...
#if QA2
        public const string GSC_AUTH_BASE_URL = "https://staging.myarta.net/";
        public const string GSC_AUTH_BASE_URL_SUB = "oauth/token";
#elif QA6
        public const string GSC_AUTH_BASE_URL = "https://auth-tst.gs-newtech.ca/";
        public const string GSC_AUTH_BASE_URL_SUB = "idp-arta/accesstoken";
#elif QA17
        public const string GSC_AUTH_BASE_URL = "https://auth-uat.gs-newtech.ca/";
        public const string GSC_AUTH_BASE_URL_SUB = "idp-arta/accesstoken";
#elif PROD || PROD1 || PROD2
        public const string GSC_AUTH_BASE_URL = "https://www.myarta.net/";  
        public const string GSC_AUTH_BASE_URL_SUB = "oauth/token";
#else // QA4 default        
        public const string GSC_AUTH_BASE_URL = "https://staging.myarta.net/";
        public const string GSC_AUTH_BASE_URL_SUB = "oauth/token";
