...
{		
	public class LandingPageButtonDisabled : LinearLayout
	{
		...
		public LandingPageButtonDisabled (Context context) :
		base (context)
		{
			Initialize ();
		}

		public LandingPageButtonDisabled (Context context, IAttributeSet attrs) :
		base (context, attrs)
		{
			Initialize ();
		}

		public LandingPageButtonDisabled (Context context, IAttributeSet attrs, int defStyle) :
