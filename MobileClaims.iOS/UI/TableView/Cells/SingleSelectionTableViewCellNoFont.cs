...
{ 
    public class SingleSelectionTableViewCellNoFont : MvxDeleteTableViewCell
    {
        public UILabel label;
        protected UIView cellBackingView;

        public SingleSelectionTableViewCellNoFont() : base () {}
        public SingleSelectionTableViewCellNoFont(IntPtr handle) : base (handle) {}
