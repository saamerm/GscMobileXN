...
namespace MobileClaims.Droid.Views
{
    ...
    public class ClaimSubmissionCompletedView : ActivityBase, IMultiRegionHost
    {
        ...
        public override void OnBackPressed()
        {
            ...
            if (backStackCount == 1)
            {
                ((ClaimSubmissionCompletedViewModel)this.ViewModel).GoBackCommand.Execute(null);
                base.OnBackPressed();
            }
            else
            {
        ...
        protected override void OnViewModelSet()
        {
            ...
            var cvf = new ClaimSubmissionCompletedFragment_
            {
                ViewModel = (ClaimSubmissionCompletedViewModel)ViewModel
            };
            Show(cvf, true);
