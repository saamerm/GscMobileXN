...
{
    public class DashboardRecentClaimsActionRequiredViewHolder : RecyclerView.ViewHolder
    {
        public TextView Description { get; set; }
        public TextView TotalAmountClaimed { get; set; }
        public TextView ServiceDate { get; set; }

        public DashboardRecentClaimsActionRequiredViewHolder(View itemView) : base(itemView)
        {
