...
{
    [Foundation.Register("ClaimTreatmentDetailsEntryPCView")]
    public class ClaimTreatmentDetailsEntryPCView : GSCBaseViewPaddingController, IGSCBaseViewImplementor
    {
        protected ClaimTreatmentDetailsEntryPCViewModel _model;
        ...
        public ClaimTreatmentDetailsEntryPCView()
        {
        }
        public override void ViewDidLoad()
        {
            ...
            _model = (ClaimTreatmentDetailsEntryPCViewModel)this.ViewModel;
            ...
            DismmssVCTableViewSource tableSource = new DismmssVCTableViewSource(typeOfEyewearList.popoverController, typeOfEyewearList.listController.tableView, "ClaimSubmissionBenefitCell", typeof(ClaimSubmissionBenefitCell));
            typeOfEyewearList.listController.tableView.Source = tableSource;



            _model.OnInvalidClaimDetails += HandleOnInvalidClaimDetails;

            var set = this.CreateBindingSet<ClaimTreatmentDetailsEntryPCView, Core.ViewModels.ClaimTreatmentDetailsEntryPCViewModel>();
            ...
            set.Bind(tableSource).To(vm => vm.TypesOfEyewear);
            set.Bind(tableSource).For(s => s.SelectedItem).To(vm => vm.TypeOfEyewear);
        ...
        void HandleOnInvalidClaimDetails(object sender, EventArgs e)
        {
            ...
            if (_model.MissingTotalAmountCharged || _model.InvalidTotalAmountCharged)
                totalAmountCharged.showError("sepcifyTotalAmountCharged".tr());
            else
        ...
        public override void ViewDidLayoutSubviews()
        {
            ...
            int redrawCountValue = Constants.IS_OS_7_OR_LATER() ? 2 : 3;
