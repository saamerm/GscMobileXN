...
namespace Cheesebaron.MvvmCross.Bindings.Droid
{
        ...
        : PagerAdapter
    {
        ...
        protected virtual void SetItemsSource(IEnumerable value)
        {
            ...
            {
                // TODO: Fix the following and uncomment.
        ...
        {
            return GetBindableView(convertView, source, parent, ItemTemplateId);
        }
        ...
        protected virtual View GetBindableView(View convertView, object source, ViewGroup parent, int templateId)
        {
            ...
            if (viewToUse == null)
                viewToUse = CreateBindableView(source, parent, templateId);
            else
                BindBindableView(source, parent, viewToUse);

            return viewToUse.Content as View;
        }

        protected virtual void BindBindableView(object source, ViewGroup parent, IMvxListItemView viewToUse)
        {
            viewToUse.DataContext = source;
        }

        protected virtual MvxListItemView CreateBindableView(object dataContext, ViewGroup parent, int templateId)
        {
            return new MvxListItemView(_context, _bindingContext.LayoutInflaterHolder, dataContext, parent, templateId);
        }
