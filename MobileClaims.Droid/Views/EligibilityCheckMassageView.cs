...
namespace MobileClaims.Droid.Views
{
    ...
    public class EligibilityCheckMassageView : BaseFragment, Android.App.DatePickerDialog.IOnDateSetListener
    {
        private EligibilityCheckMassageViewModel _model;
        private View _view;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            _view = this.BindingInflate(Resource.Layout.EligibilityCheckMassageView, null);
            return _view;
        }
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            var checkeligibilityNotes1 = Activity.FindViewById<TextView>(Resource.Id.checkeligibilityNotes1);
            checkeligibilityNotes1.Text = Resources.FormatterBrandKeywords(Resource.String.checkeligibilityNotes1, new[] { Resources.GetString(Resource.String.greenshieldcanada) });
