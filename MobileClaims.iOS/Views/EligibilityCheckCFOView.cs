...
{
    [Register("EligibilityCheckCFOView")]
    public class EligibilityCheckCFOView : GSCBaseViewPaddingController, IGSCBaseViewImplementor
    {
        protected EligibilityCheckCFOViewModel _model;
        ...
        protected UILabel eligibilityOMFView;
        ...
        public EligibilityCheckCFOView()
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            submissionTableView.RowHeight = 55 * 1 + 50 + 10;
            ...
            eligibilityOMFView = new UILabel();
            eligibilityOMFView.Font = UIFont.FromName(Constants.NUNITO_BOLD, Constants.SMALL_FONT_SIZE);
            eligibilityOMFView.TextColor = Colors.DARK_GREY_COLOR;
            eligibilityOMFView.TextAlignment = UITextAlignment.Left;
            eligibilityOMFView.BackgroundColor = Colors.Clear;
            eligibilityOMFView.LineBreakMode = UILineBreakMode.WordWrap;
            eligibilityOMFView.Lines = 0;
            eligibilityOMFView.Text = "eligibilityOMFNote".FormatWithBrandKeywords(LocalizableBrand.GreenShieldCanada);
            scrollableContainer.AddSubview(eligibilityOMFView);
            ...
            inquiryDateLabel.Font = UIFont.FromName(Constants.NUNITO_BOLD, (nfloat)Constants.SMALL_FONT_SIZE);
            ...
            var set = this.CreateBindingSet<EligibilityCheckCFOView, Core.ViewModels.EligibilityCheckCFOViewModel>();
        ...
        public override void ViewDidLayoutSubviews()
        {
            ...
            {
                float listY = yPos;
                float listHeight = _model.EligibilityCheckResults.Result.ParticipantEligibilityResults.Count * (55 * 1 + 50 + 10);
            ...
            eligibilityOMFView.SizeToFit();
            eligibilityOMFView.Frame = new CGRect(sidePadding, yPos + 5, ViewContainerWidth - sidePadding * 2, (float)eligibilityOMFView.Frame.Height + 5);
            yPos += (float)eligibilityOMFView.Frame.Height + itemPadding;
        ...
        public List<ParticipantEligibilityResult> ParticipantEligibilityResults
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    EligibilityCheckMultipleSelectionSource submissionSource = new EligibilityCheckMultipleSelectionSource(ParticipantEligibilityResults, submissionTableView, "EligibilityCheckParticipantCFOTableCell", typeof(EligibilityCheckParticipantCFOTableCell));
