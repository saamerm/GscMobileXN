...
namespace MobileClaims.Droid.Views
{
    ...
    public class ChooseClaimOrHistoryView : ActivityBase, IMultiRegionHost
    {
        ...
        public override void OnBackPressed()
        {
            ...
            if (backStackCount == 1)
            {
                ((ChooseClaimOrHistoryViewModel)this.ViewModel).GoBackCommand.Execute(null);
                base.OnBackPressed();
            }
            else
            {
        ...
        protected override void OnViewModelSet()
        {
            ...
            var cvf = new ChooseClaimOrHistoryFragment_
            {
                ViewModel = ViewModel
            };
            Show(cvf, true);
