...
{
	[Register("ClaimTreatmentDetailResultNoTreatmentTableViewCell")]
	public class ClaimTreatmentDetailResultNoTreatmentTableViewCell : MvxDeleteTableViewCell
	{
		...
		public ClaimTreatmentDetailResultNoTreatmentTableViewCell () : base () {}
		public ClaimTreatmentDetailResultNoTreatmentTableViewCell (IntPtr handle) : base (handle) {}
		...
		public override void InitializeBindings()
		{
			this.DelayBind(() =>
				{
					var set = this.CreateBindingSet<ClaimTreatmentDetailResultNoTreatmentTableViewCell,TreatmentDetail>();
