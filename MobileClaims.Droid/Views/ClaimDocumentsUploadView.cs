...
namespace MobileClaims.Droid.Views
{
    ...
    public class ClaimDocumentsUploadView : ActivityBase, IMultiRegionHost
    {
        ...
        public override void OnBackPressed()
        {
            ...
            if (backStackCount == 1)
            {
                ((ClaimDocumentsUploadViewModel)this.ViewModel).GoBackCommand.Execute(null);
                base.OnBackPressed();
            }
            else
            {
                //IBackPressedListenerHandler();
                base.OnBackPressed();
            }
        }
        ...
        protected override void OnViewModelSet()
        {
            ...
            var cvf = new ClaimDocumentsUploadFragment_
            {
                ViewModel = ViewModel
            };
            Show(cvf, true);
