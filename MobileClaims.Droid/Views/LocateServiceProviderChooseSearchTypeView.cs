...
namespace MobileClaims.Droid
{
	...
	public class LocateServiceProviderChooseSearchTypeView : BaseFragment, IMvxView 
	{
		...
		public override void OnViewCreated (View view, Bundle savedInstanceState)
		{
			...
			if (this.Resources.GetBoolean (Resource.Boolean.isTablet)) {
				_model.HasNavigated = false;
				_model.SetLocationTypeWithoutNavigationCommand.Execute (_model.SelectedLocationType);
