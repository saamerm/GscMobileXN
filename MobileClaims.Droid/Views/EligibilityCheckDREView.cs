...
namespace MobileClaims.Droid.Views
{
	...
	public class EligibilityCheckDREView : BaseFragment
	{
		EligibilityCheckDREViewModel _model;

		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			var ignored = base.OnCreateView(inflater, container, savedInstanceState);
			return this.BindingInflate(Resource.Layout.EligibilityCheckDREView, null);
		}
		...
		public override void OnViewCreated (View view, Bundle savedInstanceState)
		{
            ...
            TextView notesView = Activity.FindViewById<TextView> (Resource.Id.eligibilityResultsOrthoticNotes);
