...
namespace MobileClaims.Droid.Views
{
    ...
    public class WebAgreementView : ActivityBase, IMultiRegionHost
    {
        ...
        public override void OnBackPressed()
        {
            ...
            {
                ((WebAgreementViewModel)this.ViewModel).GoBackCommand.Execute(null);
            }
            base.OnBackPressed();
        }
        ...
        protected override void OnViewModelSet()
        {
            ...
            var webAgreementFragment = new WebAgreementFragment_
            {
                ViewModel = ViewModel
            };
            Show(webAgreementFragment);
        ...
        // The value found in android:onClick attribute.
        [Export("errorClickHandler")] 
        public void errorClickHandler(View v)
        {
            if (v.Tag != null)
            {
