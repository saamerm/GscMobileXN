...
{
	[Foundation.Register("ClaimTreatmentDetailsEntry1View")]
    public class ClaimTreatmentDetailsEntry1View : GSCBaseViewPaddingController, IGSCBaseViewImplementor
	{
		protected ClaimTreatmentDetailsEntry1ViewModel _model;
		...
		public ClaimTreatmentDetailsEntry1View ()
		{
		}
		...
		public override void ViewDidLoad ()
		{
			...
			_model = (ClaimTreatmentDetailsEntry1ViewModel)this.ViewModel;
			...
			DismmssVCTableViewSource tableSource = new DismmssVCTableViewSource (typeOfTreatmentList.popoverController,typeOfTreatmentList.listController.tableView,"ClaimSubmissionBenefitCell",typeof(ClaimSubmissionBenefitCell));
			typeOfTreatmentList.listController.tableView.Source = tableSource;

			_model.OnInvalidClaimDetails += HandleOnInvalidClaimDetails;


			var set = this.CreateBindingSet<ClaimTreatmentDetailsEntry1View, Core.ViewModels.ClaimTreatmentDetailsEntry1ViewModel>();
			set.Bind (tableSource).To (vm => vm.TypesOfTreatment);
			set.Bind(tableSource).For(s => s.SelectedItem).To (vm => vm.TypeOfTreatment);
