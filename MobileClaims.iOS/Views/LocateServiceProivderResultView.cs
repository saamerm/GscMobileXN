...
{
	[Register("LocateServiceProviderResultView")]
	public class LocateServiceProviderResultView : MvxViewController
	{
		...
		public override void ViewDidLayoutSubviews ()
		{
			...
			float viewHeight = base.View.Bounds.Height-Constants.NAV_HEIGHT;

			//mapView.Frame = new RectangleF (0, startY, viewWidth, viewHeight - startY - Constants.TAB_BAR_HEIGHT);
			mapView.Frame = new RectangleF (0, startY-25, viewWidth, viewHeight);
