...
namespace MobileClaims.Droid.Views
{
    ...
    public class ChangeForLifeNoAccessView : ActivityBase, IMultiRegionHost
    {
        ...
        public override void OnBackPressed()
        {
            ...
            {
                ((ChangeForLifeNoAccessViewModel)this.ViewModel).GoBackCommand.Execute(null);
            }
            base.OnBackPressed();
        }
        ...
        protected override void OnViewModelSet()
        {
            ...
            var cvf = new ChangeForLifeNoAccessFragment_
            {
                ViewModel = ViewModel
            };
            Show(cvf, true);
