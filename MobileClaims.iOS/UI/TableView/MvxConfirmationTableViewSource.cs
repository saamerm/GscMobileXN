...
public class MvxConfirmationTableViewSource : MvxTableViewSource
{

	public ClaimSubmissionConfirmationViewModel _model;
	public Type cellType;
	public String cellName;

	#region Constructors
	public MvxConfirmationTableViewSource(ClaimSubmissionConfirmationViewModel viewModel, UITableView tableView, String cellName, Type cellType) : base(tableView)
	{
...
//	}
	...
	public override nfloat GetHeightForRow (UITableView tableView, NSIndexPath indexPath)
	{
		...
		if (!Constants.IsPhone ()) {
			...
			titleTestLabel.Font = UIFont.FromName (Constants.NUNITO_BOLD, (nfloat)Constants.SMALL_FONT_SIZE);
			titleTestLabel.TextAlignment = UITextAlignment.Left;
			titleTestLabel.Lines = 0;

			UILabel testLabel = new UILabel();
			testLabel.Font = UIFont.FromName(Constants.NUNITO_BOLD,(nfloat)Constants.SMALL_FONT_SIZE);
