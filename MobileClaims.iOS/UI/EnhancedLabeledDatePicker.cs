...
{
    [Register("EnhancedLabeledDatePicker")]
    [DesignTimeVisible(true)]
    public class EnhancedLabeledDatePicker : UIView
    {
        ...
        public UIView ListContainerBackground { get; set; }
        ...
        public EnhancedLabeledDatePicker()
        {
        }

        public EnhancedLabeledDatePicker(IntPtr handler)
            : base(handler)
        {
        }
